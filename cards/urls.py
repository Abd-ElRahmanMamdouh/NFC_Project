...
urlpatterns = [
    ...
    path("remove-gallery-image/<uidb64>/<path:image_url>/", views.remove_gallery_image, name="remove_gallery_image"),
    path("remove-product-image/<uidb64>/<path:image_url>/", views.remove_product_image, name="remove_product_image"),
